...
void main() {
  ...
  group('PasswordLoadRequested', () {
    ...
    blocTest<PasswordBloc, PasswordState>(
      ...
      build: () {
        when(mockVaultService.getAllCards()).thenThrow(Exception('DB connection failed'));
        return passwordBloc;
      },
      act: (b) => b.add(PasswordLoadRequested()),
      expect: () => [
  ...
  group('PasswordSearchRequested', () {
    ...
    blocTest<PasswordBloc, PasswordState>(
      ...
      build: () {
        when(mockVaultService.search('github')).thenAnswer((_) async => results);
        return passwordBloc;
      },
    ...
    blocTest<PasswordBloc, PasswordState>(
      ...
      build: () {
        final all = [makePasswordCard(), makePasswordCard(cardId: kTestCardId2)];
  ...
  group('PasswordAddRequested', () {
    ...
    blocTest<PasswordBloc, PasswordState>(
      ...
      build: () {
        when(mockVaultService.createCard(payload)).thenAnswer((_) async => makePasswordCard());
        when(mockVaultService.getAllCards()).thenAnswer((_) async => updatedCards);
        return passwordBloc;
      },
    ...
    blocTest<PasswordBloc, PasswordState>(
      ...
      build: () {
        when(mockVaultService.createCard(payload)).thenThrow(StateError('Vault not unlocked'));
        return passwordBloc;
      },
      act: (b) => b.add(PasswordAddRequested(payload)),
      expect: () => [
  ...
  group('PasswordUpdateRequested', () {
    ...
    blocTest<PasswordBloc, PasswordState>(
      ...
      build: () {
        when(
          mockVaultService.updateCard(kTestCardId1, payload),
    ...
    blocTest<PasswordBloc, PasswordState>(
      ...
      act: (b) => b.add(PasswordUpdateRequested(kTestCardId1, payload)),
      expect: () => [isA<PasswordOperationInProgress>(), isA<PasswordError>()],
    );
  });
  ...
  group('PasswordDeleteRequested', () {
    ...
    blocTest<PasswordBloc, PasswordState>(
      ...
      build: () {
        when(mockVaultService.deleteCard(kTestCardId1)).thenAnswer((_) async => true);
        when(mockVaultService.getAllCards()).thenAnswer((_) async => remainingCards);
        return passwordBloc;
      },
      ...
      expect: () => [
        isA<PasswordOperationInProgress>(),
        isA<PasswordLoading>(),
        isA<PasswordLoaded>().having((s) => s.cards, 'empty after delete', isEmpty),
      ],
      verify: (_) {
    ...
    blocTest<PasswordBloc, PasswordState>(
      ...
      build: () {
        when(mockVaultService.deleteCard(kTestCardId1)).thenThrow(Exception('DB write failed'));
        return passwordBloc;
      },
      act: (b) => b.add(const PasswordDeleteRequested(kTestCardId1)),
      expect: () => [isA<PasswordOperationInProgress>(), isA<PasswordError>()],
